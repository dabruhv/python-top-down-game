...
def sheepMove(position):
    ...
    if position[2] == RIGHT and position[0]+70 < 800:
        position[0] += 2 #move right
    if position[2] == UP and position[1]>0: 
        position[1] -=2 #move up
    if position[2] == DOWN and position[1]+50 < 800:
...
sheep2 = [700, 450, RIGHT, False]
sheep3 = [450, 200, RIGHT, False]
sheep4 = [100, 700, RIGHT, False]
